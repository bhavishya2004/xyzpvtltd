...
const Update3 = () => {
    ...
    useEffect(() => {
        axios.post("http://localhost:3001/getUpdateData3", {id})
            .then(res => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        try {
            axios.post("http://localhost:3001/Update3", {id,pnumber,pname,buyingprice,bought,amountout,sellingprice,sold,stock,unitprofit,profit})
                .then((response) => {
